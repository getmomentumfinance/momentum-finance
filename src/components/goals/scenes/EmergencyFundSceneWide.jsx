...
export default function EmergencyFundSceneWide({ pct = 0 }) {
  const starsRef = useTwinkle()
  const fillHeight = (Math.min(100, Math.max(0, pct)) / 100) * 60
  const fillY = 132 - fillHeight

  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 165" preserveAspectRatio="xMidYMid meet"
      style={{ display: 'block' }} xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="efSkyGradW" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#0d1f2a" />
          <stop offset="100%" stopColor="#152a38" />
        </linearGradient>
        <linearGradient id="efRainGradW" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#1a4a5a" stopOpacity="0" />
          <stop offset="100%" stopColor="#2a7a8a" stopOpacity="0.18" />
        </linearGradient>
        <radialGradient id="efPuddleGW" cx="50%" cy="40%" r="50%">
          <stop offset="0%" stopColor="#2a8888" stopOpacity="0.35" />
          <stop offset="100%" stopColor="#1a5060" stopOpacity="0.1" />
        </radialGradient>
        <radialGradient id="efShieldGlowW" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#64e8c8" stopOpacity="0.18" />
          <stop offset="100%" stopColor="#64e8c8" stopOpacity="0" />
        </radialGradient>
        <clipPath id="efShieldClipW">
          <path d="M800 72 L826 82 L826 104 Q826 122 800 132 Q774 122 774 104 L774 82 Z" />
        </clipPath>
      </defs>

      <rect width="1600" height="165" fill="url(#efSkyGradW)" />
      ...
      <g ref={starsRef}>
        ...
        <circle data-star cx="1290" cy="14" r="1" fill="#64e8c8" opacity="0.25" />
        <circle data-star cx="1355" cy="28" r="1.2" fill="#fff" opacity="0.2" />
        <circle data-star cx="1510" cy="8" r="1" fill="#64e8c8" opacity="0.2" />
        <circle data-star cx="220" cy="30" r="1" fill="#fff" opacity="0.18" />
        <circle data-star cx="1450" cy="32" r="1" fill="#fff" opacity="0.18" />
      </g>

      {/* Far-left/right extra cloud clusters */}
      <ellipse cx="170" cy="60" rx="60" ry="22" fill="#1a3a4a" />
      <ellipse cx="150" cy="66" rx="38" ry="18" fill="#1e4050" />
      <ellipse cx="1430" cy="58" rx="65" ry="24" fill="#1a3a4a" />
      <ellipse cx="1450" cy="64" rx="40" ry="18" fill="#1e4050" />
      ...
      <g transform="translate(500,0)">
        ...
        <ellipse cx="300" cy="105" rx="42" ry="42" fill="url(#efShieldGlowW)" />
        ...
        <rect x="274" y={fillY} width="52" height={fillHeight} fill="#2a7a6a" opacity="0.55" clipPath="url(#efShieldClipW)" />
        <polyline points="289,102 298,111 313,94" fill="none" stroke="#64e8c8" strokeWidth="2.2"
          strokeLinecap="round" strokeLinejoin="round" opacity="0.9" />
      </g>

      <rect x="0" y="138" width="1600" height="27" fill="#0e2230" />
      <path d="M0 136 Q150 132 300 136 Q450 140 600 136 Q750 132 900 136 Q1050 140 1200 136 Q1350 132 1500 136 Q1560 138 1600 136 L1600 140 L0 140 Z" fill="#122838" />

      <ellipse cx="600" cy="142" rx="38" ry="6" fill="url(#efPuddleGW)" />
      <ellipse cx="800" cy="145" rx="28" ry="5" fill="url(#efPuddleGW)" />
      <ellipse cx="990" cy="141" rx="34" ry="5" fill="url(#efPuddleGW)" />
      <ellipse cx="220" cy="143" rx="30" ry="5" fill="url(#efPuddleGW)" />
      <ellipse cx="1380" cy="144" rx="32" ry="5" fill="url(#efPuddleGW)" />

      <ellipse cx="600" cy="142" rx="22" ry="3" fill="none" stroke="#2a8888" strokeWidth="0.7" opacity="0.4" />
      <ellipse cx="600" cy="142" rx="12" ry="2" fill="none" stroke="#2a8888" strokeWidth="0.6" opacity="0.3" />
      <ellipse cx="990" cy="141" rx="20" ry="3" fill="none" stroke="#2a8888" strokeWidth="0.7" opacity="0.35" />

      <rect width="1600" height="165" fill="url(#efRainGradW)" />
    </svg>
  )
}
