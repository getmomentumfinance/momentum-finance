  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 160" preserveAspectRatio="xMidYMid meet"
      ...
      <g ref={starsRef}>
        ...
        <circle data-star cx="1400" cy="12" r="1" fill="#fff" opacity="0.2" />
        <circle data-star cx="1500" cy="20" r="1.2" fill="#a08cff" opacity="0.4" />
        <circle data-star cx="1558" cy="10" r="1" fill="#fff" opacity="0.2" />
        <circle data-star cx="1330" cy="30" r="1" fill="#a08cff" opacity="0.3" />
        <circle data-star cx="350" cy="18" r="1" fill="#a08cff" opacity="0.25" />
        <circle data-star cx="1250" cy="24" r="1" fill="#a08cff" opacity="0.25" />
      </g>
      <rect x="0" y="130" width="1600" height="30" fill="#0c0c18" />
      <rect x="40" y="108" width="1520" height="24" rx="3" fill="#18162a" />
      <rect x="60" y="130" width="8" height="20" rx="2" fill="#141228" />
      <rect x="100" y="130" width="8" height="20" rx="2" fill="#141228" />
      <rect x="990" y="130" width="8" height="20" rx="2" fill="#141228" />
      <rect x="1530" y="130" width="8" height="20" rx="2" fill="#141228" />
      ...
      {/* Extra flanking desk props */}
      <rect x="120" y="92" width="44" height="16" rx="2" fill="#1e1c32" />
      <circle cx="130" cy="100" r="3" fill="#a08cff" opacity="0.5" />
      <circle cx="140" cy="100" r="3" fill="#ffa0b4" opacity="0.5" />
      <circle cx="150" cy="100" r="3" fill="#ffd250" opacity="0.5" />
      <rect x="1440" y="90" width="50" height="18" rx="2" fill="#1e1c32" />
      <rect x="1448" y="95" width="34" height="8" rx="1" fill="#221e36" />
    </svg>
  )
}
