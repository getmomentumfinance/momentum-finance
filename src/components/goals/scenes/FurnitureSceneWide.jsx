...
export default function FurnitureSceneWide() {
  const starsRef = useTwinkle()
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 160" preserveAspectRatio="xMidYMid meet"
      style={{ display: 'block' }} xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="furnSkyW" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#1a1410" /><stop offset="100%" stopColor="#221a14" />
        </linearGradient>
      </defs>
      <rect width="1600" height="160" fill="url(#furnSkyW)" />
      <rect x="0" y="0" width="1600" height="128" fill="#1a1410" />
      <rect x="0" y="124" width="1600" height="4" fill="#221a14" />
      <rect x="0" y="128" width="1600" height="32" fill="#1a1208" />
      <line x1="0" y1="134" x2="1600" y2="134" stroke="#201808" strokeWidth="1.5" />
      <line x1="0" y1="140" x2="1600" y2="140" stroke="#201808" strokeWidth="1.5" />
      <line x1="0" y1="146" x2="1600" y2="146" stroke="#201808" strokeWidth="1.5" />
      ...
      <g ref={starsRef}>
        ...
        <circle data-star cx="1520" cy="12" r="1" fill="#ffb464" opacity="0.3" />
        <circle data-star cx="1560" cy="25" r="1.2" fill="#fff" opacity="0.2" />
        <circle data-star cx="1490" cy="30" r="1" fill="#ffb464" opacity="0.2" />
        <circle data-star cx="300" cy="20" r="1" fill="#fff" opacity="0.18" />
        <circle data-star cx="1300" cy="18" r="1" fill="#ffb464" opacity="0.2" />
      </g>
      ...
      {/* Extra flanking decor */}
      <rect x="100" y="60" width="3" height="44" fill="#2a1c10" />
      <ellipse cx="101" cy="60" rx="16" ry="18" fill="#1e2818" />
      <ellipse cx="93" cy="54" rx="10" ry="13" fill="#243020" />
      <ellipse cx="109" cy="52" rx="11" ry="14" fill="#243020" />
      <rect x="1450" y="70" width="3" height="38" fill="#2a1c10" />
      <ellipse cx="1451" cy="70" rx="14" ry="16" fill="#1e2818" />
      <ellipse cx="1444" cy="64" rx="9" ry="12" fill="#243020" />
    </svg>
  )
}
