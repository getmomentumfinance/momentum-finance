  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 160" preserveAspectRatio="xMidYMid meet"
      ...
      <g ref={starsRef}>
        ...
        <circle data-star cx="1490" cy="12" r="1.2" fill="#ffd250" opacity="0.35" />
        <circle data-star cx="1555" cy="22" r="1" fill="#fff" opacity="0.2" />
        <circle data-star cx="1380" cy="18" r="1" fill="#ffd250" opacity="0.3" />
        <circle data-star cx="1520" cy="38" r="1" fill="#ffd250" opacity="0.2" />
        <circle data-star cx="350" cy="14" r="1" fill="#ffd250" opacity="0.25" />
        <circle data-star cx="1250" cy="20" r="1" fill="#ffd250" opacity="0.25" />
      </g>
      <rect x="0" y="128" width="1600" height="32" fill="#120e08" />
      ...
      {/* Extra flanking gift boxes */}
      <rect x="120" y="118" width="40" height="30" rx="3" fill="#1e1810" />
      <rect x="124" y="112" width="32" height="9" rx="2" fill="#2a2014" />
      <rect x="138" y="112" width="4" height="36" rx="1" fill="#a08cff" opacity="0.4" />
      <rect x="1420" y="112" width="46" height="36" rx="3" fill="#1a1e1a" />
      <rect x="1424" y="105" width="38" height="10" rx="2" fill="#222818" />
      <rect x="1440" y="105" width="4" height="43" rx="1" fill="#ffd250" opacity="0.4" />
    </svg>
  )
}
