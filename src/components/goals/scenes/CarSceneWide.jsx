...
export default function CarSceneWide() {
  const starsRef = useTwinkle()
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 160" preserveAspectRatio="xMidYMid meet"
      style={{ display: 'block' }} xmlns="http://www.w3.org/2000/svg">
      <rect width="1600" height="160" fill="#0f1520" />
      <path d="M0 130 L1600 130 L1600 160 L0 160 Z" fill="#141e30" />
      <path d="M0 128 L1600 128" stroke="#1e2e44" strokeWidth="2" />
      <rect x="20" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      <rect x="130" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      <rect x="240" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      <rect x="350" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      <rect x="1200" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      <rect x="1310" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      <rect x="1420" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      <rect x="1530" y="142" width="50" height="3" rx="1" fill="#2a3a54" opacity="0.7" />
      ...
      <g ref={starsRef}>
        ...
        <circle data-star cx="950" cy="12" r="1" fill="#64b4ff" opacity="0.5" />
        <circle data-star cx="1020" cy="28" r="1" fill="#64b4ff" opacity="0.4" />
        <circle data-star cx="880" cy="38" r="1" fill="#ffbe50" opacity="0.4" />
        <circle data-star cx="1080" cy="16" r="1.2" fill="#64b4ff" opacity="0.45" />
        <circle data-star cx="1250" cy="18" r="1.2" fill="#ffbe50" opacity="0.4" />
        <circle data-star cx="1340" cy="32" r="1" fill="#64b4ff" opacity="0.4" />
        <circle data-star cx="1430" cy="14" r="1.5" fill="#64b4ff" opacity="0.45" />
        <circle data-star cx="1500" cy="42" r="1" fill="#ffbe50" opacity="0.35" />
        <circle data-star cx="1560" cy="22" r="1.2" fill="#64b4ff" opacity="0.4" />
      </g>
