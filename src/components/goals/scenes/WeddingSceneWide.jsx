...
export default function WeddingSceneWide() {
  const starsRef = useTwinkle()
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 160" preserveAspectRatio="xMidYMid meet"
      style={{ display: 'block' }} xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="wedSkyW" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#1a0e18" /><stop offset="100%" stopColor="#2a1a28" />
        </linearGradient>
        <radialGradient id="wedMoonW" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#3a2035" /><stop offset="100%" stopColor="#2a1428" />
        </radialGradient>
      </defs>
      <rect width="1600" height="160" fill="url(#wedSkyW)" />
      <circle cx="800" cy="38" r="26" fill="url(#wedMoonW)" />
      <circle cx="808" cy="32" r="20" fill="#2e1a2c" />
      <g ref={starsRef}>
        ...
        <circle data-star cx="1420" cy="15" r="1" fill="#fff" opacity="0.3" />
        <circle data-star cx="1480" cy="26" r="1.2" fill="#ffa0b4" opacity="0.4" />
        <circle data-star cx="1550" cy="10" r="1" fill="#fff" opacity="0.25" />
        <circle data-star cx="1510" cy="40" r="1" fill="#ffa0b4" opacity="0.3" />
        <circle data-star cx="350" cy="18" r="1" fill="#fff" opacity="0.25" />
        <circle data-star cx="1250" cy="22" r="1.2" fill="#ffa0b4" opacity="0.35" />
      </g>
      <path d="M20 55 Q100 62 180 55 Q260 48 340 55 Q420 62 500 55 Q580 48 660 55 Q740 62 820 55 Q900 48 980 55 Q1060 62 1140 55 Q1220 48 1300 55 Q1380 62 1460 55 Q1520 51 1580 55" fill="none" stroke="#5a3040" strokeWidth="1.2" />
      <g fill="#ffdc80" opacity="0.75">
        ...
        <ellipse cx="620" cy="61" rx="3" ry="4" /><ellipse cx="660" cy="63" rx="3" ry="4" /><ellipse cx="700" cy="60" rx="3" ry="4" />
        <ellipse cx="740" cy="56" rx="3" ry="4" /><ellipse cx="780" cy="53" rx="3" ry="4" /><ellipse cx="820" cy="53" rx="3" ry="4" />
        <ellipse cx="860" cy="56" rx="3" ry="4" /><ellipse cx="900" cy="61" rx="3" ry="4" /><ellipse cx="940" cy="63" rx="3" ry="4" />
        <ellipse cx="980" cy="60" rx="3" ry="4" /><ellipse cx="1020" cy="56" rx="3" ry="4" /><ellipse cx="1060" cy="53" rx="3" ry="4" />
        <ellipse cx="1100" cy="53" rx="3" ry="4" /><ellipse cx="1140" cy="56" rx="3" ry="4" /><ellipse cx="1180" cy="61" rx="3" ry="4" />
        <ellipse cx="1220" cy="63" rx="3" ry="4" /><ellipse cx="1260" cy="60" rx="3" ry="4" /><ellipse cx="1300" cy="56" rx="3" ry="4" />
        <ellipse cx="1340" cy="53" rx="3" ry="4" /><ellipse cx="1380" cy="53" rx="3" ry="4" /><ellipse cx="1420" cy="56" rx="3" ry="4" />
        <ellipse cx="1460" cy="61" rx="3" ry="4" /><ellipse cx="1500" cy="63" rx="3" ry="4" /><ellipse cx="1540" cy="60" rx="3" ry="4" />
        <ellipse cx="1580" cy="56" rx="3" ry="4" />
      </g>

      <rect x="0" y="132" width="1600" height="28" fill="#1a1020" />
      ...
      {/* Extra flanking flower clusters far left/right */}
      <circle cx="120" cy="120" r="11" fill="#2a1828" /><circle cx="113" cy="115" r="5" fill="#3a2035" /><circle cx="127" cy="115" r="5" fill="#3a2035" /><circle cx="120" cy="126" r="5" fill="#3a2035" /><circle cx="120" cy="119" r="4" fill="#ffa0b4" opacity="0.6" />
      <circle cx="1480" cy="118" r="11" fill="#2a1828" /><circle cx="1473" cy="113" r="5" fill="#3a2035" /><circle cx="1487" cy="113" r="5" fill="#3a2035" /><circle cx="1480" cy="124" r="5" fill="#3a2035" /><circle cx="1480" cy="117" r="4" fill="#ffa0b4" opacity="0.6" />
    </svg>
  )
}
