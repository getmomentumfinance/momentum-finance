...
export default function BabySceneWide() {
  const starsRef = useTwinkle()
  return (
    <svg width="100%" height="100%" viewBox="0 0 1600 160" preserveAspectRatio="xMidYMid meet"
      style={{ display: 'block' }} xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="babySkyW" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#14101e" /><stop offset="100%" stopColor="#1e1630" />
        </linearGradient>
      </defs>
      <rect width="1600" height="160" fill="url(#babySkyW)" />
      <circle cx="990" cy="35" r="30" fill="#221840" opacity="0.8" />
      <circle cx="996" cy="30" r="22" fill="#2a1e48" />
      <circle cx="1001" cy="26" r="6" fill="#1e1638" opacity="0.5" />
      <g ref={starsRef}>
        ...
        <circle data-star cx="1330" cy="24" r="1.2" fill="#c8b4ff" opacity="0.35" />
        <circle data-star cx="1390" cy="8" r="1" fill="#fff" opacity="0.2" />
        <circle data-star cx="1460" cy="22" r="1.2" fill="#c8b4ff" opacity="0.35" />
        <circle data-star cx="1530" cy="48" r="1" fill="#c8b4ff" opacity="0.25" />
        <circle data-star cx="350" cy="18" r="1" fill="#fff" opacity="0.2" />
        <circle data-star cx="1250" cy="30" r="1" fill="#c8b4ff" opacity="0.25" />
      </g>

      {/* Extra flanking cloud clusters */}
      <ellipse cx="170" cy="62" rx="60" ry="20" fill="#1e1838" opacity="0.9" />
      <ellipse cx="148" cy="67" rx="38" ry="16" fill="#221e40" />
      <ellipse cx="1430" cy="55" rx="60" ry="19" fill="#1e1838" opacity="0.9" />
      <ellipse cx="1455" cy="60" rx="38" ry="16" fill="#221e40" />

      <rect x="0" y="128" width="1600" height="32" fill="#14101e" />
