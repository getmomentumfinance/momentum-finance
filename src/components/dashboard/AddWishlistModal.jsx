    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full left-0 right-0 mt-1 glass-popup border border-white/15 rounded-xl overflow-hidden z-20 shadow-xl max-h-52 overflow-y-auto scrollbar-thin">
          <button type="button" onClick={() => { onChange(''); setOpen(false) }} className="w-full px-3 py-2.5 text-left text-sm text-white/25 hover:bg-white/5 transition-colors">None</button>
          {options.map(opt => (
